...
/// </summary>
public sealed class LinkAnalysisItem
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the title attribute of the link.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets whether this is an external link (http/https).
    /// </summary>
    public bool IsExternal { get; set; }

    /// <summary>
    /// Gets a value indicating whether this is a relative link.
    /// </summary>
    public bool IsRelative =>
        !this.IsExternal && !string.IsNullOrEmpty(this.Url) && !this.Url.StartsWith('/');

    /// <summary>
    /// Gets a value indicating whether this is an anchor link (starts with #).
    /// </summary>
    public bool IsAnchor => !string.IsNullOrEmpty(this.Url) && this.Url.StartsWith('#');

    /// <summary>
    /// Gets or sets the position of this link in the document.
    /// </summary>
